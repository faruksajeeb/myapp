...
class MaymansingPage extends StatelessWidget {
  const MaymansingPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("ময়মনসিংহ বিভাগ", style: TextStyle(
          color: Colors.white,
          fontSize: 30,
      ...
      body: Padding(
        ...
        child: Column(
            ...
            children: [
              const Text(
                "ময়মনসিংহ বিভাগ বাংলাদেশের উত্তর-পশ্চিমানলে অবস্থিত। "
